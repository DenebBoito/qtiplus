function [model, model_SDPdcSL] = qtip_pipe_SDPdcSL_SDPdcmSL(data,btensors,D0,mask,nvox,mcheckflag,ind,parallel,cvxsolver)
...
if parallel
    parfor k = 1:y_fit
        ...
        % SDPdc
        m_fit_SDPdcSL(:,k) = qtip_data2fit_SDPdcSL(data_fit(:,k), btensors, ...
                                               'nvox', nvox,...
                                               'ind', ind, ...
                                               'D0', D0, ...
                                               'outflag', 1,...
        ...
        if mcheckflag
            ...
            if mcheckp(k) || mcheckm(k)
                m_fit(:,k) = qtip_data2fit_SDPdcmSL(m_fit_SDPdcSL(:,k), data_fit(:,k), btensors,...
                                               'nvox', nvox,...
                                               'ind', ind, ...
                                               'D0', D0, ...
                                               'outflag', 1,...
            ...
            m_fit(:,k) = qtip_data2fit_SDPdcm(m_fit_SDPdcSL(:,k),data_fit(:,k), btensors, ...
                                               'nvox', nvox,...
                                               'ind', ind, ...
                                               'D0', D0, ...
                                               'outflag', 1,...
